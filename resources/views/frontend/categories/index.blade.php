                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="instructor_search_result style2">
                            <p class="mt10 fz15"><span class="color-dark pr10">{{count($categories)}} </span> categories</p>
                        </div>
                    </div>
                    <div class="col-xl-8">
                            ...
                            <ul>
                                <li class="list-inline-item">
                                    <div class="candidate_revew_search_box course mb30 fn-520">
                                        <form class="form-inline my-2 my-lg-0" method="GET" action="/categories/search">
                                            @csrf
                                            <input class="form-control mr-sm-2" type="search" name="title" placeholder="Rechercher une categorie" aria-label="Search">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-xl-4">
                        <div class="top_courses text-truncate">
                            <div class="thumb">
                                <img class="img-whp" height="300" height="200" src="{{ Storage::url($category->image)}}" alt="t1.jpg">
                                <div class="overlay">
                                </div>
                            </div>
                            <div class="details">
                                ...
                                <div class="tc_footer text-center">
                                    <div class="tc_price">
                                        <a class="btn btn-transparent" href="{{ route('layout-frontend.categories.showcourse', $category) }}">Explorer</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="item">
                        <div class="top_courses">
                            <div class="thumb">
                                <img class="img-whp" height="300" src="{{ asset('admin/images/courses/t1.jpg')}}" alt="t1.jpg">
