            ...
            <div class="col-lg-12">
                <div class="my_course_content_container">
                    <div class="my_course_content mb30">
                        ...
                        @php
                            $chapter_ridirect = $chapters->first();
                        @endphp
                        <form id="fileUploadForm" method="POST"
                            action="{{ route('admin.lessons.storelink', ['chapter' => $chapter_ridirect]) }}"
                        ...
                        <div class="row container">
                            <div class=" text-left col py-3">
                                <a href="{{ route('admin.lessons.allVideos') }}" class="text-info">Toutes les
                                    videos</a>
                            </div>
