        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                    <h4 class="title float-left">Ajouter un livre dans<span
                            class="ml-3  text-info">{{ $bookCategory->title }}</span>
                    </h4>
            ...
            <div class="col-lg-12">
                <div class="my_course_content_container">
                    <div class="my_course_content mb30">
                        ...
                        <form method="POST" action="{{ route('admin.books.store', $bookCategory->slug) }}"
