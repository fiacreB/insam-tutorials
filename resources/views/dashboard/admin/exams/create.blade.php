        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                    <h4 class="title float-left">Examens du Chapitre : <span class="text-info">{{ $chapter->title }}</span>
                    </h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-info"
                                                        href="{{ route('admin.tests.create', $chapter, $exam) }}">
                                        ...
                                        <form action="" id="addExam" class="container">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <label for="time" class="form-label">Entrer la durée du test</label>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <form action="" id="editExam" class="container">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="form-group">
                                                    <input name="chapter_id" id="chapter_id" type="hidden"
                                                        value="{{ $chapter->id }}">
                                                </div>
    ...
    <script>
        $(document).ready(function() {
            $("#addExam").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.exams.addExam', $chapter->slug) }}",
                    type: "POST",
                    data: formData,
            ...
            $("#editExam").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.exams.updateExam', $chapter->slug) }}",
                    type: "POST",
                    data: formData,
                    success: function(data) {
                        if (data.success == true) {
