        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                    <h4 class="title float-left">Toutes les videos du: <span class="text-info">{{ $chapter->title }}</span>
                    </h4>
                ...
                <div class="my_course_content_container">
                    <div class="my_course_content mb30">
                        <div class="my_course_content_header">
                            <div class="col-xl-4">
                                <div class="instructor_search_result style2">
                                    <h4 class="mt10">videos (<span
                                            class="text-info">{{ $chapter->lessons->count() }}</span>)</h4>
                                </div>
                            </div>
                            <div class="col-xl-8">
                                <div class="candidate_revew_select style2 text-right">
                                    <ul class="mb0">
                                        <li class="list-inline-item">
                                            <a href="{{ route('admin.lessons.create', $chapter->slug) }}"
                        ...
                        <div class="row row-cols-1 row-cols-md-3 g-4 container py-3">
                            @forelse ($chapter->lessons as $video)
                                <div class="col-xl-3">
                                    <div class="card mt-4 ">
