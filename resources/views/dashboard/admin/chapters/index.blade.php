        ...
        <div class="row">
            <div class="col-lg-12">
                <nav class="breadcrumb_widgets" aria-label="breadcrumb mb30">
                    <h4 class="title float-left">All chapters
                    </h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.chapters.show', $chapter->slug) }}"
                                                class="btn btn-info"><span class="bi bi-plus"></span>Ajouter
                                                les videos</a>
                                        </td>
                                        <td>
                                            <a href="{{ route('admin.exams.examDashboard', $chapter->slug) }}"
                                                class="btn btn-secondary">
                                                <span class="bi bi-plus"></span> Ajouter un
                                                exmen</a>
                                        </td>
                                        <td class="text-right">
    ...
    <script>
        $(document).ready(function() {
            $("#addChapter").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.chapters.store', $chapter->course->slug) }}",
                    type: "POST",
                    data: formData,
            ...
            $("#editChapter").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.chapters.edit', $chapter->course->slug) }}",
                    type: "POST",
                    data: formData,
                    success: function(data) {
                        if (data.success == true) {
            ...
            $("#deleteChapter").submit(function(e) {
                ...
                $.ajax({
                    url: "{{ route('admin.chapters.deleteChapter', $chapter->course->slug) }}",
                    type: "GET",
                    data: formData,
                    success: function(data) {
                        if (data.success == true) {
